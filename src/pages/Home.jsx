      ...
      <section className="who-strip">
        <div className="who-left reveal-left">
          ...
          <p className="section-body">
            Africa Ecological Restoration Trust (AERT) is a non-profit NGO dedicated to ecological restoration and conservation across Africa. Founded on the belief that restored landscapes can transform lives, we work at the intersection of science, community, and nature.
          </p>
